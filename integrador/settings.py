...
SECRET_KEY = 'django-insecure-nub%j*1@@nbk)k6)ljrwy7#&3@2)-o^w_)39eaw1s9jy7)dklb'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'integrador',  # Cambia esto al nombre de tu base de datos
        'USER': 'root',              # Usuario de tu base de datos
        'PASSWORD': '',              # Contraseña (vacía por defecto en XAMPP)
        'HOST': '127.0.0.1',         # Host de tu base de datos
        'PORT': '3309',              # Puerto de MariaDB/MySQL
    }
}
